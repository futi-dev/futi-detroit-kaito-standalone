...
export const Name: React.FC<INameProps> = ({ className, style, ...rest }) => (
  <motion.div className={cn('flex h-12 flex-col justify-center gap-2', className)} style={style} {...rest}>
    <h1 className="my-0 px-4 font-kanit text-3xl font-light text-[#4290f4]/90 dark:text-white/90">
      Hi, I&apos;m <span className="font- font-normal text-[#4290f4]/90 dark:text-white/90">Kaito</span>
    </h1>
